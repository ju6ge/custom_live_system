...
#pacstrap $root_mount base base-devel dracut linux-lts linux-lts-headers dkms zfs-dkms squashfs-tools
...
filesystem=" squashfs "
add_dracutmodules=" systemd-udevd dmsquash-live "
kernel_cmdline=" root=live:CDLABEL=$iso_label rd.live.squashimg=rootfs.sfs rd.live.overlay.overlayfs ro "
EOF
